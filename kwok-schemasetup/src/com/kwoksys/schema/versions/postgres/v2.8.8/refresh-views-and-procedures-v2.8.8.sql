...
create or replace function sp_attribute_add(out o_attribute_id int, in p_object_type_id int, in p_attribute_name varchar(50),
    ...
    in p_attribute_url text, in p_default_attribute_field_id int, in p_attribute_group_id int, in p_input_mask varchar(50), in p_type_currency_symbol varchar(10))
RETURNS integer AS $$
begin
	select nextval('seq_attribute_id') into o_attribute_id;

	insert into attribute (attribute_id, object_type_id, attribute_key, description, attribute_url, attribute_type, attribute_option, attribute_convert_url, is_editable, default_attribute_field_id, attribute_group_id, input_mask, type_currency_symbol, is_custom_attr)
		values (o_attribute_id, p_object_type_id, p_attribute_name, p_description, p_attribute_url, p_attribute_type, p_attribute_option, p_attribute_convert_url, 1, p_default_attribute_field_id, p_attribute_group_id, p_input_mask, p_type_currency_symbol, 1);
end;
$$ LANGUAGE 'plpgsql';
...
create or replace function sp_attribute_update(in p_attribute_id int, in p_attribute_name varchar(50), in p_description varchar(255),
    ...
    in p_input_mask varchar(50), in p_type_currency_symbol varchar(10))
RETURNS void AS $$
begin
