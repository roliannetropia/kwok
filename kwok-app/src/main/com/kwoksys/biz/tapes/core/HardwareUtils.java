 ...
 * ====================================================================
 */
package com.kwoksys.biz.tapes.core;
...
public class HardwareUtils {
    ...
    public static List formatHardwareList(RequestContext requestContext, List<Hardware> hardwareDataset, Counter counter,
        ...
        return formatHardwareList(requestContext, hardwareDataset, com.kwoksys.biz.hardware.core.HardwareUtils.getColumnHeaderList(), counter, hardwarePath);
    }
        ...
        for (Hardware hardware : hardwareDataset) {
            ...
            for (String column : columnHeaders) {
                if (column.equals(Hardware.ROWNUM)) {
                    ...
                    columns.add(com.kwoksys.biz.hardware.core.HardwareUtils.formatWarrantyExpirationDate(requestContext, unixTimestamp,
