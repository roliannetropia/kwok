 ...
 * ====================================================================
 */
package com.kwoksys.biz.tapes.dao;
...
import com.kwoksys.biz.tapes.dto.Tape;
...
public class HardwareDao extends BaseDao {
    ...
    public List<Tape> getHardwareList(QueryBits query) throws DatabaseException {
        return getHardwareList(new QueryHelper(com.kwoksys.biz.tapes.dao.HardwareQueries.selectHardwareListQuery(query)));
    }
