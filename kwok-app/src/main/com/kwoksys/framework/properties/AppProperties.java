    ...
    static {
        if (props == null) {
            ...
            try {
                ...
                props.load(AppProperties.class.getResourceAsStream(AppPaths.APPLICATION_PROPERTIES));

                props.load(AppProperties.class.getResourceAsStream(AppPaths.BUILD_PROPERTIES));
