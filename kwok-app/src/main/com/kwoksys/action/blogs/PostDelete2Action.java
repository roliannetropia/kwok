 ...
 */
public class PostDelete2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.BLOG_POST_DELETE + "?postId=" + post.getId() + "&" + RequestContext.URL_PARAM_ERROR_TRUE);

        } else {
            return redirect(AppPaths.BLOG_POST_LIST);
        }
    }
}