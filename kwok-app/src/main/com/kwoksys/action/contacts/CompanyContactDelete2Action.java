 ...
 */
public class CompanyContactDelete2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.CONTACTS_COMPANY_DETAIL + "?companyId=" + contact.getCompanyId() + "&" + RequestContext.URL_PARAM_ERROR_TRUE);
