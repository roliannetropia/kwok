 ...
 */
public class CompanyEdit2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.CONTACTS_COMPANY_EDIT + "?companyId=" + company.getId() + "&" + RequestContext.URL_PARAM_ERROR_TRUE);
