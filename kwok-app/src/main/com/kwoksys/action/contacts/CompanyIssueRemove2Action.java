...
/**
 * Action class for removing a Company Issue mapping.
 */
public class CompanyIssueRemove2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.CONTACTS_COMPANY_ISSUES + "?companyId=" + companyId + "&" + RequestContext.URL_PARAM_ERROR_TRUE);
