 ...
 */
public class GroupDelete2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.ADMIN_GROUP_DELETE + "?" + RequestContext.URL_PARAM_ERROR_TRUE + "&groupId=" + groupId);

        } else {
            return redirect(AppPaths.ADMIN_GROUP_LIST);
        }
    }
}