...
/**
 * Action class for adding contract detail.
 */
public class ContractAdd2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.CONTRACTS_ADD + "?" + RequestContext.URL_PARAM_ERROR_TRUE);
        } else {
