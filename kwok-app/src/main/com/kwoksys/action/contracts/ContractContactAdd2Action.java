...
/**
 * Action class for adding Contract Contact.
 */
public class ContractContactAdd2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.CONTRACTS_CONTACT_ADD + "?contractId=" + contract.getId() + "&" + RequestContext.URL_PARAM_ERROR_TRUE);

        } else {
            return redirect(AppPaths.CONTRACTS_CONTACTS + "?contractId=" + contract.getId());
        }
    }
}