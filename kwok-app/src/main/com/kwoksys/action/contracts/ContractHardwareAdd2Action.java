...
/**
 * Action class for adding hardware to contract.
 */
public class ContractHardwareAdd2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.CONTRACTS_HARDWARE_ADD + "?contractId=" + contract.getId() + "&" + RequestContext.URL_PARAM_ERROR_TRUE);
