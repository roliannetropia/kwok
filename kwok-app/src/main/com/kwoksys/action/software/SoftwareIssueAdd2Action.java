 ...
 */
public class SoftwareIssueAdd2Action extends Action2 {
    ...
    public String execute() throws Exception {
        ...
        if (!errors.isEmpty()) {
            ...
            return redirect(AppPaths.SOFTWARE_ISSUE_ADD + "?softwareId=" + softwareId + "&" + RequestContext.URL_PARAM_ERROR_TRUE);
