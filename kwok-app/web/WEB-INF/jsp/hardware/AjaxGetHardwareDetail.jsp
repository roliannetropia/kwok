...
<table class="standard">
    <tr><td><h2><bean:write name="hardwareSpecTemplate" property="headerText"/></h2></td>
    <td align="right"><a href="javascript:hideDivMenu(hardwareDetail);"><img src="${image.popupClose}"></a></td></tr>
</table>
