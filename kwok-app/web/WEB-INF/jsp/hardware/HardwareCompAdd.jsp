...
<table class="tabBody">
    <tr class="header1">
        <td colspan="2"><b><bean:message key="itMgmt.cmd.hardwareComponentAdd"/></b></td>
    </tr>
    <tr>
        <td>
        <table class="standardForm">
            <tr>
                <th nowrap="nowrap"><bean:message key="common.requiredFieldIndicator.true"/><bean:message key="common.column.hardware_component_type"/>:</th>
