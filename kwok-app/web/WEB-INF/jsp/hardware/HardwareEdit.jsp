...
<table class="standardForm">
    <tr>
        ...
        <td><bean:write name="hardware" property="id"/></td>
    ...
    <tr>
        <th><bean:message key="common.column.hardware_reset_last_service_date"/>:</th>
        <td><html:checkbox name="form" property="lastServicedOn" value="1"/>
            <span class="formFieldDesc"><bean:message key="itMgmt.colDesc.hardware_last_service_date"/></span></td>
