...
<h2><bean:message key="admin.customAttrAdd.header"/>
...
<table class="standardForm">
    <tr>
        ...
        <td><input type="text" name="attrName" value="<bean:write name="form" property="attrName"/>" size="48" maxlength="50" autofocus></td>
    </tr>
    <tr>
