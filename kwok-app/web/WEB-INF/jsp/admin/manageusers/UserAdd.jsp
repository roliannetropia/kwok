...
<table class="standardForm">
    <tr>
        ...
        <td><input type="text" name="username" value="<bean:write name="form" property="username"/>" size="40" autofocus></td>
    </tr>
    <tr>
        <th><bean:message key="common.requiredFieldIndicator.true"/><bean:message key="common.column.user_first_name"/>:</th>
        <td><html:text name="form" property="firstName" size="40" onkeyup="refreshDisplayName(this, this.form.lastName, this.form.displayName)"/></td>
        <th><bean:message key="common.requiredFieldIndicator.true"/><bean:message key="common.column.user_last_name"/>:</th>
        <td><html:text name="form" property="lastName" size="40" onkeyup="refreshDisplayName(this.form.firstName, this, this.form.displayName)"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><html:select name="form" property="status" onchange="tooglePasswordFields(this.value, 'passwordSpan', 'confirmPasswordSpan')">
    ...
    <logic:equal name="allowPasswordUpdate" value="true">
    <tr>
        <th>
            <logic:equal name="allowBlankPassword" value="false">
                <span id="passwordSpan"><bean:message key="common.requiredFieldIndicator.true"/></span>
            </logic:equal>
            <bean:message key="common.column.user_password"/>:</th>
        <td><html:password name="form" property="password" size="40"/> </td>
        <th>
            <logic:equal name="allowBlankPassword" value="false">
                <span id="confirmPasswordSpan"><bean:message key="common.requiredFieldIndicator.true"/></span>
            </logic:equal>
            <bean:message key="common.column.user_password_confirm"/>:</th>
        <td><html:password name="form" property="confirmPassword" size="40"/> </td>
    </tr>
    </logic:equal>
