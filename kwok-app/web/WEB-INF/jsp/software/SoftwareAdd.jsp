...
<table class="standardForm">
    ...
    <td><html:select name="form" property="manufacturerId">
        ...
        </html:select> <html:img src="${image.helpIcon}" titleKey="help.addSoftwareMaker" styleClass="standard" alt=""/></td>
    </tr>
    <tr>
    ...
    <td><html:select name="form" property="vendorId">
        ...
        </html:select> <html:img src="${image.helpIcon}" titleKey="help.addSoftwareVendor" styleClass="standard" alt=""/></td>
    </tr>
    <tr>
