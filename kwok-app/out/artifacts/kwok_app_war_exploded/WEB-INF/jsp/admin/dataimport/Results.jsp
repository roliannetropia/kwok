...
<tr class="header1">
    ...
    <th><bean:message key="import.heading.result"/></th>
...
<logic:iterate id="row" name="dataList">
    ...
    <tr>
        ...
        <td><bean:message key="import.result.${importItem.action}"/></td>
        <td>
...
<p>
<html:link action="${formBackAction}" styleClass="cancel"><bean:message key="import.back.home"/></html:link>