...
<tr class="header1"><td colspan="2"><b><bean:message key="itMgmt.hardwareDetail.addLicenseHeader"/> </b></td></tr>
<tr>
    <td class="row2" width="20%"><bean:message key="itMgmt.hardwareDetail.addLicenseStep1"/></td>
    <td class="row2">
        ...
        <logic:empty name="softwareOptions" >
            <bean:message key="itMgmt.hardwareDetail.noSoftware"/>
        </logic:empty>
    </td>
</tr>
<tr>
    <td class="row2"><bean:message key="itMgmt.hardwareDetail.addLicenseStep2"/></td>
...
<tr>
<td class="row2"><bean:message key="itMgmt.hardwareDetail.addLicenseStep3"/></td>
<td class="row2">
    <logic:notEmpty name="softwareOptions">
...
<form action="${formRemoveLicenseAction}" method="post">
    ...
    <logic:notEmpty name="installedLicenses">
        ...
        <logic:equal name="canRemoveLicense" value="true">
            <tr class="header1"><td colspan="${colSpan}"><input type="submit" value="<bean:message key="itMgmt.hardwareDetail.removeLicenseButton"/>" onclick="return confirmSubmit('<bean:message key="common.form.confirmRemove"/>')"></td></tr>
        </logic:equal>
    </logic:notEmpty>
